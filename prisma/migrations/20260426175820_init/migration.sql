-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'MEDICO', 'ENFERMEIRO', 'RECEPCIONISTA', 'DIRETOR_CLINICO');

-- CreateEnum
CREATE TYPE "CorTriagem" AS ENUM ('VERMELHO', 'LARANJA', 'AMARELO', 'VERDE', 'AZUL', 'CINZA');

-- CreateEnum
CREATE TYPE "StatusAtendimento" AS ENUM ('AGUARDANDO_TRIAGEM', 'EM_TRIAGEM', 'AGUARDANDO_ATENDIMENTO', 'EM_ATENDIMENTO', 'CONCLUIDO', 'TRANSFERIDO', 'ALTA', 'OBITO');
